-- Question: What are the most optimal skills for data engineers in the remote job market, balancing both demand and salary?
...
/*
┌────────────┬───────────────┬──────────────┬─────────────────┬───────────────┐
│   skill    │ median_salary │ demand_count │ ln_demand_count │ optimal_score │
...
🎵 Tell me more, tell me more, what's the optimal score? 🎵
